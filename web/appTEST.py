...
appTEST.title = "Random COVID Simulation"
...
appTEST.layout = html.Div([
  ...
  html.Nav([
    html.Br(),
    # Add callback
    dcc.Link("Close Menu", href="javascript:void(0)", className="w3-button w3-hide-large w3-display-topleft", style={"width":"100%","font-size":"22px"}, id="closeMenu"),
    ...
    html.Div([
      ...
      dcc.Link("Visuals", href="appTEST.py", className="w3-bar-item w3-button w3-hover-white")
...
@appTEST.callback(dash.dependencies.Output('page-content', 'children'),
