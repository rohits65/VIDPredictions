...
def createCases(popSize,incPeriod,illPeriod,r0Arr, startingDay, newByDay):
    ...
    for i in range(index,stop-1):
        ...
        check = add/11 #11 or 12? 11 dropped peak early
        if check > 1:
            check = 1
...
if __name__ == "__main__": 
    ...
    - [6] --> id
    '''
    data = [1,1,3,2,2,3,6,4,8,5,6,2,3,18,13,12,23,24,17,20,14,7,67,39,19,73,84,83,32,17,55,202,42,66,63,75,54,59,17,61,95,62]
    
    
    # multiprocessDef(2,[[0.15, 1], [0.4, 3], [0.75,2], [0.9,4], [1,0]], "truePopulationWithData4-10xe", 43, data, 2)
    multiprocessDef(2, [[0.9, 1],[1, 2]], "truePopulationWithData4-10xe", 36, [1,1,3,2,2,3,6,4,8,5,6,2,3,18,13,12,23,24,17,20,14,7,67,39,19,73,84,83,32,17,55,202,42,66,63,75], 5)
    dictionary = {}
