...
if __name__ == "__main__": 
    ...
    multiprocessDef(2,[[0.15, 1], [0.4, 3], [0.75,2], [0.9,4], [1,0]], "truePopulationWithData4-10xd", 43, data, 2)
    dictionary = {}
    operate.operate("truePopulationWithData4-10xd", dictionary, data, 0)
